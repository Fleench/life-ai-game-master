...
namespace GameMaster.ReplApp.ViewModels;
...
public partial class MainViewModel : ViewModelBase
{
    ...
    private async void ProcessCommand(string input)
    {
        try
        {
            ...
            var playerService = GameMaster.ReplApp.AppHost.Services.GetService<GameMaster.Core.Services.IPlayerService>();
            var pointsService = GameMaster.ReplApp.AppHost.Services.GetService<GameMaster.Core.Services.IPointsService>();
            var inventoryService = GameMaster.ReplApp.AppHost.Services.GetService<GameMaster.Core.Services.IInventoryService>();
            var appRegistryService = GameMaster.ReplApp.AppHost.Services.GetService<GameMaster.Core.Services.IAppRegistryService>();
